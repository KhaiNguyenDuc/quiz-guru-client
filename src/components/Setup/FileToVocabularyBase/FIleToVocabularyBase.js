      ...
      <form className="mt-5" onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className="row my-5 mx-2">
          <div className="col">
            ...
            >
              <option value={"SINGLE_CHOICE_QUESTION"}>Một đáp án</option>
              <option value={"MULTIPLE_CHOICE_QUESTION"}>Nhiều đáp án</option>
              <option value={"SINGLE_CHOICE_AND_MULTIPLE_CHOICE"}>Ngẫu nhiên</option>
            </select>
          </div>
          <div className="col">
            <h5>Số lượng</h5>
